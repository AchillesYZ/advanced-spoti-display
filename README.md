...
7. wait for Stasis to approve and send the needed items
8. build the final device

## Platform and Tools

The current planned platform is:

- Raspberry Pi
- Python
- Spotify Web API
- Display-based user interface
- GitHub for planning, logging, and code management
